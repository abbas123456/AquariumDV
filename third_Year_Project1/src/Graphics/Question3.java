 ...
 * This panel is used to display the third question of the quiz
 */
public class Question3 extends JPanel implements ActionListener, MouseListener, MouseMotionListener
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g2.drawString("Question 3", 20, 40);
        g.setColor(Color.BLACK);
        g.setFont(new Font("Comic Sans MS",0,28));
        g.drawString("What will happen if all the prey die?", 20, 100);
        if(selected==1)
            g.setColor(Color.WHITE);
        else
        ...
        g.drawString("The predators will die", 60, 220);
        if(selected==3)
            g.setColor(Color.WHITE);
        else
        ...
        g.drawString("There will be more predators", 60, 270);
