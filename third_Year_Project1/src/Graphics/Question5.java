 ...
 * This panel is used to display the fifth question of the quiz
 */
public class Question5 extends JPanel implements ActionListener, MouseListener, MouseMotionListener
{
    ...
    public void mousePressed(MouseEvent e)
    {
        ...
        {            
            ...
            x3 = 80;
            y3 = 360;
            GUI.card3.show(GUI.p5,"6");
        }
        else if(e.getX()>183 && e.getX()<333&&e.getY()>310&&e.getY()<365&&(moved1&&moved2&&moved3)&&!ready)
        {
            if(this.x1+i1.getWidth(null)<260&&this.x3>265&&this.x2>265
