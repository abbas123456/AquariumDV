 ...
 * This panel is used to display the second question of the quiz
 */
public class Question2 extends JPanel implements ActionListener, MouseListener, MouseMotionListener
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g.drawString("Question 2", 20, 40);
        g.setColor(Color.BLACK);
        g.setFont(new Font("Comic Sans MS",0,28));
        g.drawString("What is at the start of a food chain?", 20, 100);
        if(selected==1)
            g.setColor(Color.WHITE);
        else
        ...
        g.drawString("A green plant", 60, 220);
        if(selected==3)
            g.setColor(Color.WHITE);
        else
